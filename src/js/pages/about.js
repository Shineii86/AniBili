 ...
 *
 *  Description:
 *      Static about page with project description, feature list,
 *      GitHub link, and AniList attribution.
 *
 * ============================================================================
 */
 ...
 *
 *  @tips
 *      - Pure static content (no async, no state)
 *      - External links open in new tab with noopener
 *      - SVG icons inline for Discord and GitHub
 */
export function renderAbout(app) {
  ...
  html += `<h1 class="section-title" style="margin-bottom:8px">About AniBili</h1>`;
  ...
  html += `<a class="about-row" href="https://github.com/Shineii86/AniBili" target="_blank" rel="noopener noreferrer">${githubIcon}<span class="about-card-text"><span class="about-link-title">Source on GitHub</span><span class="about-link-text">Star the project, report issues, or contribute</span></span></a>`;
  html += `</div>`;
  html += `</div>`;

  // ---- FEATURE: ATTRIBUTION ----
  html += `<div class="about-more">`;
  html += `<div class="about-dev-header"><span class="about-dev-badge">Powered by</span></div>`;
  html += `<a class="about-platform" href="https://anilist.co" target="_blank" rel="noopener noreferrer">`;
  html += `<div class="about-platform-body">`;
  html += `<div class="about-link-title">AniList</div>`;
  html += `<div class="about-platform-desc">Anime discovery and metadata powered by the AniList GraphQL API.</div>`;
  html += `</div>`;
  html += `</a>`;
  html += `</div>`;
...
/**
 * ============================================================================
 *  END OF ABOUT PAGE MODULE
 * ============================================================================
 *
 *  Exports:
 *      - renderAbout() - Render about page
 *
 * ============================================================================
 */
